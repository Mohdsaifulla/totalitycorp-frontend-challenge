          ...
          >
            <div className="w-full h-[260px] relative">
              ...
              <div className="w-12 h-24 absolute bottom-10 right-0 border-[1px] border-gray-400 bg-white rounded-md flex flex-col translate-x-20 group-hover:translate-x-0 transition-transform duration-300">
                ...
                <span className="w-full h-full sborder-b-[1px] border-gray-400 flex items-center justify-center text-xl bg-transparent hover:bg-amazon_yellow cursor-pointer duration-300">
                  <FaHeart />
                </span>
              </div>
              {isNew && (
            ...
            <div className="px-4 py-3 flex flex-col gap-1">
              ...
              <p className="flex items-center gap-2">
                ...
                <span className="text-amazon_yellow font-semibold">
